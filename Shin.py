        ...
        if part.get_content_type() == 'application/pdf':
            ...
            for chapter_num, chapter_text in enumerate(chapters, start=1):
                ...
                try:
                    ...
                    logging.error(f"Error summarizing chapter {chapter_num}: {str(e)}")
    ...
    with imaplib.IMAP4_SSL(imap_url) as my_mail:
        ...
        with ThreadPoolExecutor() as executor:
            ...
            for num in mail_id_list:
                ...
                futures.append(executor.submit(process_email, msg))

            for future in futures:
                info_list.extend(future.result())

    return info_list

if st.button("Fetch and Display PDF Summaries"):
    try:
        info_list = fetch_emails()
